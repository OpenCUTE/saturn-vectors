...
object FSIN_V    extends VectorInstruction { val props = Seq(F6(OPFFunct6.funary1)  , F3(VectorConsts.OPFVV), RS1(10.U(5.W)), FPSwapVdV2.N, FPAdd.N, FPMul.N) }
object FCOS_V    extends VectorInstruction { val props = Seq(F6(OPFFunct6.funary1)  , F3(VectorConsts.OPFVV), RS1(11.U(5.W)), FPSwapVdV2.N, FPAdd.N, FPMul.N) }
